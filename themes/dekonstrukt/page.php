...
<?php endwhile; endif; ?>
					...
					<footer class="entry_meta">
						<br />
						<a href="<?php the_permalink(); ?>" title="<?php _e('Permalink', 'sprachkonstrukt'); ?>">#</a> <time datetime="<?php the_time('c') ?>"><?php the_time(get_option('date_format')); ?>, <?php the_time(); ?></time><br />
